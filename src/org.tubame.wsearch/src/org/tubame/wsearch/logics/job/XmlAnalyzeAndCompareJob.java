...
import org.tubame.wsearch.logics.obsvr.WSearchXmlAnalyzeProcessObserver;

/**
 * Jobs EclipsePlatform to compare processing Xml and analyze. <br/>
 */
public class XmlAnalyzeAndCompareJob extends Job {
     ...
     */
    public XmlAnalyzeAndCompareJob(String name, List<String> extensions,
    ...
    protected IStatus run(IProgressMonitor monitor) {
        ...
        for (String extension : this.extensions) {
            List<String> targets = this.targetsMap.get(extension);
            if (targets != null) {
        ...
        WSearchAnalyzeAndCompareProcessor analyzeAndCompareProcessor = new WSearchAnalyzeAndCompareProcessor(
                1, starter, phaseCountDownLatch, PARSER.XML);
        WSearchProcessObserver observer = new WSearchXmlAnalyzeProcessObserver(
        ...
        try {
            ...
            String message = Activator
                    .getResourceString(XmlAnalyzeAndCompareJob.class.getName()
                            + ".err.msg.StarterErr");
