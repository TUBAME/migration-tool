 ...
 */
public class WSearchPreferenceTop extends PreferencePage implements
    ...
    private static final Logger LOGGER = LoggerFactory
            .getLogger(WSearchPreferenceTop.class);

    /**
     * Constructor.<br/>
     * Nothing in particular.<br/>
     */
    public WSearchPreferenceTop() {
     ...
     *            Title
     */
    public WSearchPreferenceTop(String title) {
        super(title);
    }
     ...
     *            Image
     */
    public WSearchPreferenceTop(String title, ImageDescriptor image) {
        super(title, image);
    }
    ...
    protected Control createContents(Composite parent) {
        ...
        pathsGroup.setText(Activator
                .getResourceString(WSearchPreferenceTop.class.getName()
                        + ".label.description"));
