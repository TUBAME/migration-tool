...
public class UpDownItemAction extends Action implements IViewActionDelegate {
    ...
    private static final String UP_KNOWHOW_ITEM_ID = "tubame.knowhow.maintenance.portability.ui.actions.UpItemAction";
    /** Know-how items move under ID. */
    private static final String DOWN_KNOWHOW_ITEM_ID = "tubame.knowhow.maintenance.portability.ui.actions.DownItemAction";
