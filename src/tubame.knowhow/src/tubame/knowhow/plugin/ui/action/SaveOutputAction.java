...
public class SaveOutputAction implements IEditorActionDelegate {
    ...
    private static final String SAVE_KNOWHOW_XML_ACTION_ID = "tubame.knowhow.maintenance.portability.ui.actions.SaveKnowhowAction";
    /** DocBook save ID */
    private static final String SAVE_DOCBOOK_ACTION_ID = "tubame.knowhow.maintenance.portability.ui.actions.SaveDocBookAction";
