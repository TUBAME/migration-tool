...
import tubame.knowhow.plugin.ui.preference.KnowhowPreferenceInitializer;
...
public class Activator extends AbstractUIPlugin {
    ...
    /** The plug-in ID */
    public static final String PLUGIN_ID = "tubame.knowhow"; //$NON-NLS-1$
