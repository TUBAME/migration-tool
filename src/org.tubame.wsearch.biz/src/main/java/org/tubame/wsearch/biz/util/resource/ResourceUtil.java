 ...
 */
package org.tubame.wsearch.biz.util.resource;
...
/**
 * This is a class to manage the resource information.<br/>
 */
public class ResourceUtil {
    ...
    static {
        try {
            resource = PropertyResourceBundle
                    .getBundle("properties.wsearch.resource");
    ...
    /**
     * Get the set value corresponding to the key from the properties file.<br/>
     * 
     * @param key
     *            Key
     * @return Setting
