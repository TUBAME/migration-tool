 ...
 */
public class ReportGenWizardAction implements IObjectActionDelegate {
    ...
    private static final Logger LOGGER = LoggerFactory
            .getLogger(ReportGenWizardAction.class);

    /**
     * Constructor.<br/>
     */
    public ReportGenWizardAction() {
        super();
    ...
    public void run(IAction action) {
        LOGGER.info(MessageUtil.INF_SHOW_REPORTGENWIZARD);

        WizardDialog wizardDialog = new WizardDialog(shell,
                new ReportGenWizard(window, this.resource));
