/*
 * JbmSearchResultLabelProvider.java
...
/**
 * Label provider of search results editing screen.<br/>
 * Show the data that was in the (level) each level.<br/>
 * Class of the data and {@link JbmEditorMigrationRow} reference.<br/>
 */
public class JbmSearchResultLabelProvider extends ColumnLabelProvider implements
