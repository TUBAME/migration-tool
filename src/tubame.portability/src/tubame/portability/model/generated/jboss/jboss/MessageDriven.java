...
@XmlType(name = "", propOrder = { "ejbName", "activationConfig",
        "destinationJndiName", "localJndiName", "mdbUser", "mdbPasswd",
        "mdbClientId", "mdbSubscriptionId", "resourceAdapterName",
        "exceptionOnRollback", "timerPersistence", "configurationName",
        "invokerBindings", "securityProxy", "ejbRef", "ejbLocalRef",
        "serviceRef", "resourceRef", "resourceEnvRef", "messageDestinationRef",
        "securityIdentity", "depends", "iorSecurityConfig",
        "ejbTimeoutIdentity" })
