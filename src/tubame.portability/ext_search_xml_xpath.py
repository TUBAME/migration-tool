...
"""
def ext_search(pNo, pPriority, pFlag, pList, pKey1, pKey2, pInputCsv, pTargetDir, pChapterNo, pCheck_Status,result_path_handle_func=None):
    ...
    for fname in pList:
        try :
            ...
            if checkedDict['unsupportedEncoding'] == True and unsupported_retry_counter == 1: 
                ...
                try:
                    ext_search(pNo, pPriority, pFlag, pList, pKey1, pKey2, pInputCsv, pTargetDir, pChapterNo, pCheck_Status,result_path_handle_func)
                    unsupported_retry_counter = 0
                    try_charset_dict = None
                except Exception ,ex:
                    try_charset_dict = None
