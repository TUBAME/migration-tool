...
def ext_search(pNo, pPriority, pFlag, pList, pGenTargetDir, pRules, pInputCsv, pTargetDir, pChapterNo, pCheck_Status):
    ...
    calcators = [{"calclator":"KnowhowDegreeOfDifficultySumCalclator", "type": "fromAp","condtions":condtions1,"execCreateResultMap":True,"tpl" :["ap"]},
                 ...
                 {"calclator":"FrameworkKnowhowFactorSumCalclator", "type": "toFw","condtions":condtions3,"execCreateResultMap":True,"tpl" :["mvc","struts"]} ,
                 ...
                 {"calclator":"FrameworkKnowhowFileCategorySumCalclator", "type": "toFw","condtions":condtions3,"execCreateResultMap":True,"tpl" :["mvc","struts"]},
