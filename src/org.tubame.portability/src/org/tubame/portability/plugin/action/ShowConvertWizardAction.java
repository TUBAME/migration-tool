...
import org.tubame.portability.plugin.wizard.JbmConvertWizard;
...
/**
 * Conversion run action class.<br/>
 */
public class ShowConvertWizardAction implements IObjectActionDelegate {
    ...
    private static final Logger LOGGER = LoggerFactory
            .getLogger(ShowConvertWizardAction.class);

    /**
     * Constructor.<br/>
     */
    public ShowConvertWizardAction() {
        super();
    ...
    public void run(IAction action) {
        ...
        WizardDialog wizardDialog = new WizardDialog(shell,
                new JbmConvertWizard(window, this.resource));
